    ...
    <>
      ...
      <SEO
        ...
        meta={[
          {
            property: `og:image`,
            content: `https://res.cloudinary.com/baadaa/image/fetch/f_auto,w_1200,h_630,c_fill/https://basinbald.com${article.frontmatter.headerImg.publicURL}`,
          },
        ]}
      />
      <PostHeroImgSection
    ...
    <>
      ...
      <SEO
        ...
        meta={[
          {
            property: `og:image`,
            content: `https://res.cloudinary.com/baadaa/image/fetch/f_auto,w_1200,h_630,c_fill/https://basinbald.com${piece.frontmatter.headerImg.publicURL}`,
          },
        ]}
      />
      <PostHeroImgSection
